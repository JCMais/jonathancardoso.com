...
> You may have noted that the enviornment variables have a common prefix, `MYRNAPP_RELEASE_`, you can change this to anything that would make more sense for your project.  
